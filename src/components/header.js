      ...
      render(){
        return (
            ...
            <ul className="navbar-nav ml-auto">
                ...
                <li className="nav-item">
                <a className="nav-link" data-widget="control-sidebar" data-slide="true"  role="button"><i className="fas fa-th-large" /></a>
                </li>
                <li className="nav-item">
                    <a className="nav-link" role="button" onClick={this.logOut}><i className="fas fa-sign-out-alt" /> Salir</a>
                </li>
            </ul>
            </nav>
        );
